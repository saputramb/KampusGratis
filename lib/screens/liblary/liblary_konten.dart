...
import 'package:kampus_gratis/screens/liblary/widget/page_indicator.dart';

class LiblaryKonten extends StatefulWidget {
  @override
  _LiblaryKontenState createState() => _LiblaryKontenState();
}

class _LiblaryKontenState extends State<LiblaryKonten> {
  final List options = [
    {
    ...
    child: GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isActive ? Colors.black : AppColor.infocolor,
