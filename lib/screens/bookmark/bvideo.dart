...
import 'package:kampus_gratis/screens/bookmark/VideoModel.dart';
...
// meengambil data di sqflite untuk bookmark
  getData() async {
    videomodel.clear();
    var list = await DB().getAllVideo();
    list.forEach((element) {
      videomodel.add(element as VideoModel);
    });
    setState(() {});
  }
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return VideoPage(
                                      videos: videomodel,
                                      selectedModel: videomodel[index],
                                    );
                                  },
                                ),
                              );
